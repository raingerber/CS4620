...
class Node 
{
  ...
  public:
    ...
    virtual Location* Emit(CodeGenerator *generator, int *count) {
      //printf("default emit function\n");
      return NULL;
    }
    Location *getTacLoc() { return tacLoc; }
    //FnDecl* getParentFn();
    ClassDecl* getParentClass();

    // used to avoid casting to stmtblock or fndecl
