...
class Operator : public Node 
{
  ...
  public:
    ...
    bool isUnaryNot() { return strcmp(tokenString, "!")==0; } // matt
    bool isUnaryMinus() { return strcmp(tokenString, "-")==0; } // matt
 };
...
class CompoundExpr : public Expr
{
  ...
  public:
    ...
    Expr* getRightMostExpr() {
      Expr *temp = right;
      while (dynamic_cast<CompoundExpr*>(temp) != NULL) {
        temp = dynamic_cast<CompoundExpr*>(temp)->right;
      }
      return temp;
    }
};
