...
class Node 
{
  ...
  public:
    ...
    Hashtable<Decl*> *localTable;

    virtual void Check() {
        //printf("DEFAULT CHECK FUNC.\n");
    }

    virtual void CreateTables() {
        //printf("DEFAULT CREATE TABLE FUNC.\n");
        localTable = NULL;
    }

/*    Node* findMatchingNodeInLowerScopes() {
        Node* p, match;
        while ((p = GetParent()) != NULL) {
            match = p->localTable->Lookup(this->getName())
        }
        return p;
    }*/
